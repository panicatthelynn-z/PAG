...
scenario = {
    ...
    two: {
        image: "http://i64.tinypic.com/1z4zhx3.png",
    ...
    three: {
        image: "http://i65.tinypic.com/2m3gtnk.jpg",
    ...
    five: {
        image: "http://i64.tinypic.com/1z4zhx3.png",
        text: "Hi! This is Programming Across Generations level one. Here, you will get your feet wet in a prgramming language known as 'Python'.",
        buttons: [
            ["Continue", "advanceTo(scenario.six)"]
        ]
    },
    ...
    eight: {
        image: "http://i65.tinypic.com/apd17s.jpg",
    ...
    twentyone: {
        image: "http://i66.tinypic.com/doszug.jpg",
    ...
    twentynine: {
        image: "http://i64.tinypic.com/30x7o8z.jpg",
    ...
    thirtyfour: {
        image: "http://i63.tinypic.com/28jbeo8.jpg",
    ...
    thirtyfive: {
        image: "http://i63.tinypic.com/28jbeo8.jpg",
        text: "Make the color anything that you want. I'll make the home for my turtle light blue by writing the line 'window.bgcolor('yellow')'. Click Run after to see the results.",
        buttons: [
    ...
    fourtyone: {
        image: "http://i63.tinypic.com/11rgmls.png",
    ...
    fourtyfour: {
        image: "http://i64.tinypic.com/ef58x.png",
    ...
    fourtysix: {
        image: "http://i67.tinypic.com/2l2iow.png",
    ...
    sixtyone: {
        image: "data_types.png",
        text: "Of course, there are more data types than this. If you would like to know more about data types, check out the supplemental content section of the Programming Across Generations website.",
        buttons: [
    ...
    seventythree: {
        image: "http://i63.tinypic.com/sfxxl3.png",
    ...
    seventyeight: {
        image: "http://i63.tinypic.com/35b5ufm.png",
    ...
    ninety: {
        image: "http://i64.tinypic.com/28l6udd.png",
    ...
    ninetysix: {
        image: "http://i63.tinypic.com/rtj02u.png",
    ...
    onehundredthree: {
        image: "http://i68.tinypic.com/o5ck92.png",
    ...
    onehundredthirtyone: {
        image: "http://i64.tinypic.com/1688zs1.png",
    ...
    onehundredfortyfour: {
        image: "http://i67.tinypic.com/jl5a2s.png",
        text: "Respond to this please: https://forms.office.com/Pages/ResponsePage.aspx?id=H8Fgk-aQBketACX83J4u0UhJQwwQ1KBAlqjtH2fnfvdUNVhFSThXODBXWUhKVUNTRFhMM0QxNjREMC4u",
    },
};
...
//Initial advance to call to the dictionary
